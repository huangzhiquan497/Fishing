...
public class ScenePrelude_TwoCircleRotate : ScenePrelude
{
    [System.Serializable]
    ...
    public IEnumerator _Coro_Process()
    {
        ...
        int numCircle = GameMain.Singleton.ScreenNumUsing;
        ...
        {
            Locals_Center[i].x = GameMain.Singleton.WorldDimension.x + GameMain.Singleton.WorldDimension.width / numCircle * (0.5F + i);
            
            Locals_Center[i].y = 0F;
            Locals_Center[i].z =Defines.GMDepth_Fish;// Defines.GMDepth_Fish;
