...
public class BackStageSetting : MonoBehaviour {
    ...
    public GunLayoutType _Def_GunLayoutType = GunLayoutType.W10;
    ...
    public static GunLayoutType Def_GunLayoutType
    {
        get
        {
            return GameMain.Singleton.BSSetting._Def_GunLayoutType;
        }
    }
    ...
    { 
        ...
        GunLayoutType_.SetImmdiately(Def_GunLayoutType);
