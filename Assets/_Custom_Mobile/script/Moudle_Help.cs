...
public class Moudle_Help : MonoBehaviour
{
    ...
    void init_Baike()
    {
        ...
        go_Baike.transform.Find("button/fanhui").GetComponent<tk2dUIItem>().OnClick += Back_BaikeClick;
    }
    ...
    void Handle_GameHelp()
    {
        ...
        go_Help.transform.Find("button/fanhui").GetComponent<tk2dUIItem>().OnClick += Back_Click;

        go_Help.transform.Find("button/baike").GetComponent<tk2dUIItem>().OnClick += Baike_Click;

        go_Help.transform.Find("button/jiaocheng").GetComponent<tk2dUIItem>().OnClick += Jiaocheng_Click;
    }
    void Baike_Click()
    {
        wiipay.EvtLog("Game_Help_BtnEncyclopedias");

        //go_Help.transform.FindChild("button/fanhui").GetComponent<tk2dUIItem>().OnClick -= Back_Click;

       // go_Help.transform.FindChild("button/baike").GetComponent<tk2dUIItem>().OnClick -= Baike_Click;

      //  go_Help.transform.FindChild("button/jiaocheng").GetComponent<tk2dUIItem>().OnClick -= Jiaocheng_Click;
        go_Baike.SetActive(true);
    ...
    void Jiaocheng_Click()
    {
        wiipay.EvtLog("Game_Help_BtnCourse");
        go_Help.SetActive(false);
        if (go_Jiaocheng1 == null)
            go_Jiaocheng1 = Instantiate(Prefab_Jiaocheng1) as GameObject;
        else
            go_Jiaocheng1.SetActive(true);
        go_Jiaocheng1.transform.Find("next").GetComponent<tk2dUIItem>().OnClick += next1;
    }
    ...
    void next1()
    {
        ...
        go_Jiaocheng2.transform.Find("next").GetComponent<tk2dUIItem>().OnClick += next2;
    }
    void next2()
    {
        ...
        go_Jiaocheng3.transform.Find("next").GetComponent<tk2dUIItem>().OnClick += next3;
    }
    void next3()
    {
        ...
        go_Jiaocheng4.transform.Find("next").GetComponent<tk2dUIItem>().OnClick += next4;
    }
    void next4()
    {
        switch (Moudle_main.iState)
